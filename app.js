...
var addButton=document.querySelector(".add-panel__btn");//first button
...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className = "task-list__item_input_checkbox";
    editInput.type="text";
    editInput.className="task task_input_text";
